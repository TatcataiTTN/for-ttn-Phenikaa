...
const I18N = {
  vi: {
    ...
    nav_quiz: "Trắc nghiệm (80 câu)",
    nav_exercises: "Bài tập tương tác",
    nav_compare: "So sánh PaiNN vs siVQLM",
    nav_about: "Giới thiệu",
    quiz_hint: "80 câu hỏi trắc nghiệm chia làm 8 nhóm chủ đề, trích từ tài liệu tự học đã kiểm chứng (Exam_Practice/QML_Force_Fields_MCQ_80.tex). Chấm điểm ngay tại trình duyệt, tiến độ lưu ở localStorage của máy bạn (không gửi lên server nào). Câu hỏi giữ nguyên tiếng Anh gốc để khớp đúng với đáp án đã kiểm chứng.",
  ...
  en: {
    ...
    nav_quiz: "Quiz (80 questions)",
    nav_exercises: "Interactive exercises",
    nav_compare: "PaiNN vs siVQLM comparison",
    nav_about: "About",
    quiz_hint: "80 multiple-choice questions in 8 topic groups, drawn from the verified self-study document (Exam_Practice/QML_Force_Fields_MCQ_80.tex). Graded instantly in the browser; progress is stored in your browser's localStorage only.",
