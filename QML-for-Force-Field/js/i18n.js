...
const I18N = {
  vi: {
    ...
    quiz_hint: "240 câu hỏi trắc nghiệm chia làm 24 nhóm chủ đề (Phần 1: kiến trúc PaiNN/siVQLM — nhóm 1–8; Phần 2: bối cảnh lịch sử/khoa học — nhóm 9–24), trích từ tài liệu tự học đã kiểm chứng (Exam_Practice/QML_Force_Fields_MCQ_240.tex). Chấm điểm ngay tại trình duyệt, tiến độ lưu ở localStorage của máy bạn (không gửi lên server nào). Câu hỏi giữ nguyên tiếng Anh gốc để khớp đúng với đáp án đã kiểm chứng.",
  ...
  en: {
    ...
    quiz_hint: "240 multiple-choice questions in 24 topic groups (Part 1: PaiNN/siVQLM architecture — groups 1–8; Part 2: historical/scientific context — groups 9–24), drawn from the verified self-study document (Exam_Practice/QML_Force_Fields_MCQ_240.tex). Graded instantly in the browser; progress is stored in your browser's localStorage only.",
